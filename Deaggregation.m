...
format long
Y = input_IMs(value);
%input_IMs,sno,Tp,fault_type,Vs,file
...
reshaped_deagg = reshape(Deagg_PGA1,[400 20]);
file_name = strcat('C:\Users\lakshd5\Dropbox\Bayesian_IM_selection\Accounting for heteroskedasticity\Final analysis 05_28_2016\Exact measure for sufficiency\Deaggregation\',file,'\deagg_',num2str(Y),'.txt');
